...
from .utils import (lookup_zodiac, lookup_chinese_zodiac, check_palindrome,
                    ...
                    get_random_hangout, get_hangout, print_message, add_question_trivia,
                    ...
                    judge_answer, stop_trivia_game, get_leaderboard, req_next_question)
...
@bot.message_handler(regexp=r'^stop zonk$')
@message_decorate
def stop_zonk(message):
    app.logger.debug("stop zonk")
    ...
    group_id = message.chat.id
    result = stop_trivia_game(group_id)
    bot.reply_to(message, result)
    if(result == "game stopped"):
        leaderboard = get_leaderboard(group_id)
